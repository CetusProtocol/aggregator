...
public fun enable_version(_self: &mut Registry, _version: u64, _cap: &DeepbookAdminCap) {
    abort 0
}

public fun disable_version(_self: &mut Registry, _version: u64, _cap: &DeepbookAdminCap) {
    abort 0
}
...
public(package) fun register_pool<BaseAsset, QuoteAsset>(_self: &mut Registry, _pool_id: ID) {
    abort 0
}

public(package) fun unregister_pool<BaseAsset, QuoteAsset>(_self: &mut Registry) {
    abort 0
}
