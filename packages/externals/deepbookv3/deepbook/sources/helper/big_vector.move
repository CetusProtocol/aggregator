...
public(package) fun borrow<E: store>(_self: &BigVector<E>, _ix: u128): &E {
    abort 0
}

public(package) fun borrow_mut<E: store>(_self: &mut BigVector<E>, _ix: u128): &mut E {
    abort 0
}

public(package) fun insert<E: store>(_self: &mut BigVector<E>, _key: u128, _val: E) {
    abort 0
}

public(package) fun remove<E: store>(_self: &mut BigVector<E>, _key: u128): E {
    abort 0
}
...
public(package) fun slice_around<E: store>(_self: &BigVector<E>, _key: u128): (SliceRef, u64) {
    abort 0
}

public(package) fun slice_following<E: store>(_self: &BigVector<E>, _key: u128): (SliceRef, u64) {
    abort 0
}

public(package) fun slice_before<E: store>(_self: &BigVector<E>, _key: u128): (SliceRef, u64) {
    abort 0
}
...
public(package) fun borrow_slice<E: store>(_self: &BigVector<E>, _ref: SliceRef): &Slice<E> {
    abort 0
}
