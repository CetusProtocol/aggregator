...
public(package) fun update(_self: &mut History, _trade_params: TradeParams, _ctx: &TxContext) {
    abort 0
}

public(package) fun reset_volumes(_self: &mut History, _trade_params: TradeParams) {
    abort 0
}
...
public(package) fun add_volume(_self: &mut History, _maker_volume: u64, _account_stake: u64) {
    abort 0
}
...
public(package) fun add_total_fees_collected(_self: &mut History, _fees: Balances) {
    abort 0
}
